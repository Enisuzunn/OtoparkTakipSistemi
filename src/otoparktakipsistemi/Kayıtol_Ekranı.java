 ...
 * @author enisuzun
 */
public class Kayıtol_Ekranı extends javax.swing.JFrame {

    /**
     * Creates new form Kayıtol_Ekranı
     */
    public Kayıtol_Ekranı() {
        initComponents();
    }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(kullanciadi_alani)
                            .addComponent(parola_alani, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(205, 205, 205)
                        .addComponent(kayitol_butonu, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void kayitol_butonuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kayitol_butonuActionPerformed
      ...
      String parola = new String(parola_alani.getPassword());
        ...
        ArrayList<User> user_list = GirişEkranı.getUser_list();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kayıtol_Ekranı.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kayıtol_Ekranı().setVisible(true);
            }
        });
    }
